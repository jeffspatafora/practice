...
person = { "first_name" => 'petey', last_name: 'catafora', email: 'petey@email.com'}
...
people = [
  { first_name: 'jib', last_name: 'son', email: 'jibson@email.com' },
  { first_name: 'jon', last_name: 'sob', email: 'jonsob@email.com' },
  { first_name: 'jib', last_name: 'son', email: 'jibson@email.com' }
]
...
menu = { hotdog: 70, fries: '2K', drink: '$60'}
...
laptops = [
  { brand: 'honda', model: 'spacebook' },
  { brand: 'john_dear', model: 'oldbook 2' },
  { brand: 'dear_john', model: 'laptop 3' }
]
...
p number_times_two(2)

# 2. Write a function that takes in a string and returns the string with all capital letters. Then run the function and print the result.

def to_all_caps(string)
  string.upcase
end

p to_all_caps('hello world')
